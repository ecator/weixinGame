	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://www.weixin199.com/youxi",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://www.weixin199.com/youxi";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://www.weixin199.com/youxi";
y.url = function() {
	return "http://www.weixin199.com/youxi?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://www.weixin199.com/youxi/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://www.weixin199.com/youxi"
			}, this);
